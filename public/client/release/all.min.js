...
postcardControllers.controller("SelectTemplateController",["$rootScope","$scope","$window","$location","$http","$routeParams","Util",function(e,t,i,a,h,n,r){function o(e,t,i){var a=e.getBoundingClientRect();return{x:t-a.left,y:i-a.top}}function c(){function e(){if(i.clearRect(-500,-1e3,2e3,2e3),0===t.selectTemplateType)0>=a&&p.width*n<l.width/c&&(a=0),0>=a&&a+p.width*n<l.width/c&&p.width*n>=l.width/c&&(a=l.width/c-(a+p.width*n)+a),a>0&&a+p.width*n>l.width/c&&p.width*n<l.width/c&&(a=l.width/c-p.width*n),a>0&&a+p.width*n>l.width/c&&p.width*n>=l.width/c&&(a=0),0>=h&&p.height*n<l.height/c&&(h=0),0>=h&&h+p.height*n<l.height/c&&p.height*n>=l.height/c&&(h=l.height/c-(h+p.height*n)+h),h>0&&h+p.height*n>l.height/c&&p.height*n<l.height/c&&(h=l.height/c-p.height*n),h>0&&h+p.height*n>l.height/c&&p.height*n>=l.height/c&&(h=0);else{var e=-p.height*n;h>=e&&p.height*n<l.width/c&&(h=e),h>e&&h>=-l.width/c&&p.height*n>=l.width/c&&(h=-l.width/c),e>=h&&h<-l.width/c&&p.height*n<l.width/c&&(h=-l.width/c),e>=h&&p.height*n>=l.width/c&&(h=e),0>=a&&p.width*n<l.height/c&&(a=0),0>=a&&a+p.width*n<l.height/c&&p.width*n>=l.height/c&&(a=l.height/c-(a+p.width*n)+a),a>0&&a+p.width*n>l.height/c&&p.width*n<l.height/c&&(a=l.height/c-p.width*n),a>0&&a+p.width*n>l.height/c&&p.width*n>=l.height/c&&(a=0)}i.drawImage(p,0,0,p.width,p.height,a*c,h*c,p.width*n*c,p.height*n*c)}var i=l.getContext("2d"),a=0,h=0,n=.5,c=r.getPixelRatio();0===t.selectTemplateType?(i.clearRect(0,0,l.width,l.height),i.rotate(0),i.drawImage(p,0,0,p.width,p.height,a*c,h*c,p.width*n*c,p.height*n*c)):(i.clearRect(0,0,l.width,l.height),i.rotate(Math.PI/2),a=0,h=-p.height*n,i.drawImage(p,0,0,p.width,p.height,a*c,h*c,p.width*n*c,p.height*n*c));var s=document.getElementById("templateCanvas"),d={x:0,y:0};s.ontouchstart=function(i){var r=o(s,i.touches[0].clientX,i.touches[0].clientY);if(2===i.touches.length){var c=o(s,i.touches[1].clientX,i.touches[1].clientY);d.x=(r.x+c.x)/2,d.y=(r.y+c.y)/2}var l=0;s.ontouchmove=function(i){if(1===i.touches.length){var c=o(s,i.touches[0].clientX,i.touches[0].clientY),d=c.x-r.x,p=c.y-r.y;r=c,0===t.selectTemplateType?(a+=d,h+=p):(a+=p,h-=d)}if(2===i.touches.length){var u=i.touches[0].clientX,g=i.touches[0].clientY,w=i.touches[1].clientX,m=i.touches[1].clientY,f=0;if(0===l)return void(l=Math.pow(Math.pow(u-w,2)+Math.pow(g-m,2),.5));f=Math.pow(Math.pow(u-w,2)+Math.pow(g-m,2),.5)-l,n*=f>0?1.02:.98}e()}}}function s(){var e=parseInt($("#templateCanvas").css("height"));$("#templateCanvas").css("width",1181*e/1748),$("#templateCanvas").css("left",parseInt($("#image-container").css("width"))/2-parseInt($("#templateCanvas").css("width"))/2),$("#pictureCanvas").css("width",$("#templateCanvas").css("width")),$("#pictureCanvas").css("left",$("#templateCanvas").css("left")),$("#pictureCanvas").attr("width",2*parseInt($("#pictureCanvas").css("width"))),$("#pictureCanvas").attr("height",2*parseInt($("#pictureCanvas").css("height"))),c()}function d(){if(t.showTemplates=[],0===t.selectTemplateType){for(var e in t.data.imgTemplates){var i=t.data.imgTemplates[e];"0"===i.rotate&&t.showTemplates.push(i)}s()}if(1===t.selectTemplateType){for(var e in t.data.imgTemplates){var i=t.data.imgTemplates[e];"-90"===i.rotate&&t.showTemplates.push(i)}s()}}if(e.leftButtonText="<更换图片",e.rightButtonText="信息填写>",e.onHeaderLeftButtonClick=function(){WeixinJSBridge&&WeixinJSBridge.call("closeWindow")},e.onHeaderRightButtonClick=function(){e.selectedTemplate=t.showTemplates[t.selectTemplateIndex],e.order&&e.order.id?h.post("/postcard/updateOrder/"+e.order.id+"?nonce="+r.getNonceStr(),{templateIndex:t.showTemplates[t.selectTemplateIndex].id}).success(function(e){0===e.code?a.path("/editInfo"):alert(e.msg)}).error(function(e){alert(e)}):h.post("/postcard/placeorder?nonce="+r.getNonceStr(),{templateIndex:t.showTemplates[t.selectTemplateIndex].id,offsetX:0,offsetY:0,userName:e.username,userPicUrl:e.picurl,actId:e.activityId,partnerId:null}).success(function(t){0===t.code?(e.order||(e.order={}),e.order.id=t.orderId,a.path("/editInfo")):alert(t.msg)}).error(function(e){alert(e)})},e.username=n.username,e.activityId=n.actId,!e.username)return void h.get("/postcard/getOauthUrl",{params:{url:a.absUrl()}}).success(function(e){0==e.code?i.location.href=e.oauthUrl:alert("获取授权url错误")}).error(function(e){alert(e)});t.selectTemplateType=0,t.selectTemplateIndex=0,t.showTemplates=[],t.data=null;var l=document.getElementById("pictureCanvas");l.width=2e3,l.height=2e3;var p=new Image;h.get("/postcard/getTemplates?"+r.getQueryStringFromObject({orderId:e.order&&e.order.id,picurl:n.picurl,actId:e.activityId,partnerId:e.partnerId,username:n.username})).success(function(i){t.data=i.data,e.username=t.data.username,e.activityId=t.data.actId,e.order=t.data.order,e.picurl=decodeURIComponent(t.data.picurl),n.mediaId&&(e.picurl+="&media_id="+n.mediaId),d(),p.src=e.picurl,p.onload=function(){c()}}).error(function(){}),h.get("/postcard/getWeixinConfig?"+r.getQueryStringFromObject({})).success(function(e){r.configWeixin(e.config)}).error(function(){}),window.onresize=s,t.reshowTemplates=function(e){t.selectTemplateType=e,d()},t.getClass=function(e){return t.selectTemplateType===e?"active-01":null},t.showUpTriangle=function(e){return t.selectTemplateType===e};var u=document.getElementById("templateCanvas");u.width=2e3,u.height=2e3,t.selectedTemplate=function(e){t.selectTemplateIndex=e;var i=u.getContext("2d"),a=new Image;a.src=t.showTemplates[t.selectTemplateIndex]&&t.showTemplates[t.selectTemplateIndex].url,a.onload=function(){i.clearRect(0,0,u.width,u.height),i.drawImage(a,0,0,u.width,u.height)}},r.overlay.init("<img style='width: 100%' src='images/tips.png'/><div id='closeIcon' style='width: 50px; height: 50px; position: absolute; top: 0; right: 0;'></div>",{transparent:!0}),r.overlay.show(),$("#closeIcon").on("click",function(){r.overlay.hide()})}]);
...
postcardControllers.controller("EditContactController",["$rootScope","$scope","$window","$location","$http","$routeParams","Util",function(e,t,r,o,c,a,n){e.leftButtonText="<取消",e.rightButtonText="",e.onHeaderLeftButtonClick=function(){o.path("/editInfo")},e.onHeaderRightButtonClick=function(){},t.addressBook=function(){o.path("/addressBook")},t.provinces=Provinces;var i=e.targetContact;if(i){t.name=i.contactName,t.address=i.address,t.mobile=i.mobile,t.zipcode=i.zipCode;var d=n.getProvinceAndCityFromAddress(t.address);d.province&&(t.selectedProvince=d.province,t.selectedCity=d.city,t.address=t.address.replace(new RegExp(t.selectedProvince,"g"),""),t.address=t.address.replace(new RegExp(t.selectedCity,"g"),""))}t.cities=function(){if(!t.selectedProvince)return[];for(var e=0,r=Provinces.length;r>e;e++)if(Provinces[e].province===t.selectedProvince)return Provinces[e].cities.split("|");return[]},t.fillZipcode=function(){var e=t.selectedProvince,r=t.selectedCity,o=t.address;c.get("/contact/postcode",{params:{address:e+r+o}}).success(function(e){0==e.code&&(t.zipcode=e.data)})},t.onOkButtonClick=function(){var r=t.name;if(!r)return void alert("请填写联系人姓名");var a=t.selectedProvince;if(!t.selectedProvince)return void alert("请选择省份");var n=t.selectedCity;if(!n)return void alert("请选择城市");var i=t.address;if(!i)return void alert("请填写详细地址");var d=t.mobile;if(!d)return void alert("请填写手机号");var s=t.zipcode;if(!s)return void alert("请填写邮编");var l=a+n+i;c.post("/postcard/addcontact",{userName:e.username,contactName:r,address:l,zipCode:s,mobile:d}).success(function(c){t.data=c.data,e.targetContact||(e.targetContact={}),e.targetContact.contactName=r,e.targetContact.address=l,e.targetContact.mobile=d,e.targetContact.zipCode=s,o.path("/editInfo")}).error(function(e){alert(e)})};new IScroll("#iscrollWrapper",{click:!0,scrollbars:!0})}]);
...
postcardControllers.controller("PreviewController",["$rootScope","$scope","$window","$location","$http","$routeParams","Util",function(t,o,e,r,n,l,c){t.leftButtonText="<信息填写",t.rightButtonText="确认支付>",t.onHeaderLeftButtonClick=function(){r.path("/editInfo")},t.onHeaderRightButtonClick=function(){r.path("/order")},setTimeout(function(){new IScroll("#iscrollWrapper",{click:!0,scrollbars:!0})},300)}]);
