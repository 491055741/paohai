...
postcardControllers.controller("LikeController",["$rootScope","$scope","$window","$location","$http","$routeParams","Util",function(e,t,r,i,n,a,o){function c(){function e(){i.clearRect(-500,-1e3,2e3,2e3),i.drawImage(l,0,0,l.width,l.height,n*s,a*s,l.width*c*s,l.height*c*s)}var r=document.getElementById("pictureCanvas");r.width=1181,r.height=1748;var i=r.getContext("2d"),n=0,a=0,c=1,s=o.getPixelRatio();if(t.selectTemplateType=-90==h.rotate?1:0,0===t.selectTemplateType?(i.clearRect(0,0,r.width,r.height),i.rotate(0),i.drawImage(l,0,0,l.width,l.height,n*s,a*s,l.width*c*s,l.height*c*s)):(i.clearRect(0,0,r.width,r.height),i.rotate(Math.PI/2),n=0,a=-l.height*c,i.drawImage(l,0,0,l.width,l.height,n*s,a*s,l.width*c*s,l.height*c*s)),e(),h){var d=document.getElementById("templateCanvas");d.width=1181,d.height=1748;var i=d.getContext("2d"),u=new Image;u.src=h.url,u.onload=function(){i.clearRect(0,0,d.width,d.height),i.drawImage(u,0,0,d.width,d.height)}}}function s(){var e=parseInt($("#templateCanvas").css("height"));$("#templateCanvas").css("width",1181*e/1748),$("#templateCanvas").css("left",parseInt($("#cardPreview").css("width"))/2-parseInt($("#templateCanvas").css("width"))/2),$("#pictureCanvas").css("width",$("#templateCanvas").css("width")),$("#pictureCanvas").css("height",$("#templateCanvas").css("height")),$("#pictureCanvas").css("left",$("#templateCanvas").css("left")),c()}e.leftButtonText="<信息填写",e.rightButtonText="",e.onHeaderLeftButtonClick=function(){e.templateOrder=t.order,i.path("/editInfo")},e.onHeaderRightButtonClick=function(){};var d=a.orderId,l=new Image,h=null;n.get("/postcard/getOrder?"+o.getQueryStringFromObject({orderId:d})).success(function(e){t.order=e.data.order,t.order.front=o.getFrontUrl(t.order),l.src=t.order.front,l.onload=function(){n.get("/postcard/getTemplates?"+o.getQueryStringFromObject({orderId:t.order.id,actId:t.order.activityId})).success(function(e){for(var r=e.data.imgTemplates,i=0,n=r.length;n>i;i++){var a=r[i];if(t.order.templateId==a.id){h=a;break}}c()})}}).error(function(){}),t.isLike=!1,t.likeActive=function(){return t.isLike?"like-active":"like-inactive"},t.isUnlike=!1,t.unlikeActive=function(){return t.isUnlike?"unlike-active":"unlike-inactive"},t.onClickLikeButton=function(){t.isLike||(t.isLike=!0,t.order.like=parseInt(t.order.like)+1,n.post("/postcard/updateOrder/"+d+"?nonce="+o.getNonceStr(),{like:!0}).success(function(e){}).error(function(e){alert(e)}))},t.onClickUnlikeButton=function(){t.isUnlike||(t.isUnlike=!0,t.order.unlike=parseInt(t.order.unlike)+1,n.post("/postcard/updateOrder/"+d+"?nonce="+o.getNonceStr(),{unlike:!0}).success(function(e){}).error(function(e){alert(e)}))},s(),window.onresize=s}]);
