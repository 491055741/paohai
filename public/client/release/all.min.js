...
postcardControllers.controller("PreviewController",["$rootScope","$scope","$window","$location","$http","$routeParams","Util",function(t,e,a,i,h,n,r){function c(){function t(){n.clearRect(-500,-1e3,2e3,2e3),n.drawImage(l,0,0,l.width,l.height,c*h,s*h,l.width*i*h,l.height*i*h)}var a=document.getElementById("pictureCanvas");a.width=1181,a.height=1748;var i=1,h=r.getPixelRatio();-90==o.rotate?(e.selectTemplateType=1,i=a.height/l.width/h):(e.selectTemplateType=0,i=a.width/l.width/h);var n=a.getContext("2d"),c=0,s=0;if(0===e.selectTemplateType?(n.clearRect(0,0,a.width,a.height),n.rotate(0),n.drawImage(l,0,0,l.width,l.height,c*h,s*h,l.width*i*h,l.height*i*h)):(n.clearRect(0,0,a.width,a.height),n.rotate(Math.PI/2),c=0,s=-l.height*i,n.drawImage(l,0,0,l.width,l.height,c*h,s*h,l.width*i*h,l.height*i*h)),t(),o){var d=document.getElementById("templateCanvas");d.width=1181,d.height=1748;var n=d.getContext("2d"),p=new Image;p.src=o.url,p.onload=function(){n.clearRect(0,0,d.width,d.height),n.drawImage(p,0,0,d.width,d.height);new IScroll("#iscrollWrapper",{click:!0,scrollbars:!0})}}}function s(){var t=parseInt($("#templateCanvas").css("height"));$("#templateCanvas").css("width",1181*t/1748),$("#templateCanvas").css("left",parseInt($("#cardPreview").css("width"))/2-parseInt($("#templateCanvas").css("width"))/2),$("#pictureCanvas").css("width",$("#templateCanvas").css("width")),$("#pictureCanvas").css("height",$("#templateCanvas").css("height")),$("#pictureCanvas").css("left",$("#templateCanvas").css("left"))}t.leftButtonText="<信息填写",t.rightButtonText="确认支付>",t.onHeaderLeftButtonClick=function(){i.path("/editInfo")},t.onHeaderRightButtonClick=function(){i.path("/order")};var l=new Image;l.src=t.picurl,l.onload=function(){c()};var o=t.selectedTemplate;s()}]);
