...
postcardControllers.controller("LikeController",["$rootScope","$scope","$window","$location","$http","$routeParams","Util",function(e,t,r,n,o,i,c){e.leftButtonText="<信息填写",e.rightButtonText="",e.onHeaderLeftButtonClick=function(){e.templateOrder=t.order,n.path("/editInfo")},e.onHeaderRightButtonClick=function(){};var l=i.orderId;o.get("/postcard/getOrder?"+c.getQueryStringFromObject({orderId:l})).success(function(e){t.order=e.data.order,t.order.front=c.getFrontUrl(t.order)}).error(function(){}),t.isLike=!1,t.likeActive=function(){return t.isLike?"like-active":"like-inactive"},t.isUnlike=!1,t.unlikeActive=function(){return t.isUnlike?"unlike-active":"unlike-inactive"},t.onClickLikeButton=function(){t.isLike||(t.isLike=!0,t.order.like=parseInt(t.order.like)+1,o.post("/postcard/updateOrder/"+l+"?nonce="+c.getNonceStr(),{like:!0}).success(function(e){}).error(function(e){alert(e)}))},t.onClickUnlikeButton=function(){t.isUnlike||(t.isUnlike=!0,t.order.unlike=parseInt(t.order.unlike)+1,o.post("/postcard/updateOrder/"+l+"?nonce="+c.getNonceStr(),{unlike:!0}).success(function(e){}).error(function(e){alert(e)}))}}]);
